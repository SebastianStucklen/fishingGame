...
uncommon1 = image.load('resources/uncommon1.png')
uncommon2 = image.load('resources/uncommon2.png')
uncommon3 = image.load('resources/uncommon3.png')

rare1 = image.load('resources/rare1.png')
rare2 = image.load('resources/rare2.png')

epic1 = image.load('resources/epic1.png')
epic2 = image.load('resources/epic2.png')

legendary1 = image.load('resources/legendary1.png')
legendary2 = image.load('resources/legendary2.png')
